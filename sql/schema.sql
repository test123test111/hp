...
CREATE TABLE `order` (
  ...
  `arrive_date` int(11) NOT NULL DEFAULT 0,
  `insurance` tinyint(4) NOT NULL DEFAULT '0',
  `to_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0:直接收件人 1:平台库',
  ...
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0:预订单 1:待审批 2:已审批',
  `is_del` tinyint(4) NOT NULL DEFAULT '0',
  ...
  `fee_approval_uid` int(11) NOT NULL DEFAULT '0',
